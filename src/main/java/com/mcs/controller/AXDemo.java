...
import com.mcs.service.impl.AxServiceImpl;
...
public class AXDemo {
     ...
     */
    private final static String OMPAPPKEY = "dGkohXk54Q3RRB4QCSZYE00dK3R9"; // APP_Key
    private final static String OMPAPPSECRET = "n3lK73gix7UXcuD1Oy4qxZXNAkuc"; // APP_Secret
    private final static String OMPDOMAINNAME = "https://rtcapi.cn-north-1.myhuaweicloud.com:12543"; // APP接入地址

    public static void main(String[] args) {
          AxService ax = new AxServiceImpl();
        // 第一步: 号码绑定,即调用AX模式绑定接口
         //ax.axBindNumber("17858848171", "17072855441", "0");

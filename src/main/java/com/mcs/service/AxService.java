...
public interface AxService {
     ...
     */
    String axBindNumber(String origNum, String privateNum, String calleeNumDisplay);
     ...
     *                       subscriptionId和(origNum,privateNum)二选一即可,当都传入时,优先选用subscriptionId
     */
    String axUnbindNumber(String subscriptionId, String origNum, String privateNum);
